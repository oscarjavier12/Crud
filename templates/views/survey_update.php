<div class="container">
    <div class="row">
        <div class="col-md-8">
            ...
            <form method="POST" action="/survey/actualizar" id="surveyForm" class="card p-4 shadow bg-white rounded-3">
                <div class="mb-3">
                ...
                <div class="text-center">
                    <button type="submit" id="updateSurveyButton" class="btn btn-primary">Actualizar evaluación</button>
                </div>
            </form>
